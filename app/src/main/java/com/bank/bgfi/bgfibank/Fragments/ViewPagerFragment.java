...
import com.bank.bgfi.bgfibank.Model.MyViewpager;
...
public class ViewPagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final MyViewpager viewPager = (MyViewpager) v.findViewById(R.id.pager);
        final Tabs_Viewpager_Adapter adapter = new Tabs_Viewpager_Adapter
